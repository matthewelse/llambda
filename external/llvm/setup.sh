...
base_cflags="$($llvm_config --cflags) -I$(pwd)/llvm-project/llvm/include"
...
(library
 ...
 (libraries $depends)
 (default_implementation ${modname}_$default_mode))
" > "$basedir/common/dune"
...
create_dune_file     llvm.executionengine executionengine            llvm_executionengine executionengine_ocaml "llvm llvm_target ctypes.foreign" "executionengine mcjit native"

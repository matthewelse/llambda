...
let%expect_test "post-order visit" =
  ...
  [%expect {|
    ...
    then:                                             ; preds = %entry
      %3 = getelementptr i8, i8* %t, i64 8
      %load = bitcast i8* %3 to i8**
      %4 = load i8*, i8** %load, align 8
      %5 = call ocamlcc i8* @camlTest__postorder_XXX(i8* %f, i8* %4)
      %6 = getelementptr i8, i8* %t, i64 16
      %load1 = bitcast i8* %6 to i8**
      %7 = load i8*, i8** %load1, align 8
      %8 = call ocamlcc i8* @camlTest__postorder_XXX(i8* %f, i8* %7)
      %load2 = bitcast i8* %f to i8**
      %9 = load i8*, i8** %load2, align 8
      %load3 = bitcast i8* %t to i8**
      %10 = load i8*, i8** %load3, align 8
      %func_cast = bitcast i8* %9 to i8* (i8*, i8*)*
      %11 = call ocamlcc i8* %func_cast(i8* %10, i8* %f)
      br label %merge

    else:                                             ; preds = %entry
      %load4 = bitcast i8* %f to i8**
      %12 = load i8*, i8** %load4, align 8
      %load5 = bitcast i8* %t to i8**
      %13 = load i8*, i8** %load5, align 8
      %func_cast6 = bitcast i8* %12 to i8* (i8*, i8*)*
      %14 = call ocamlcc i8* %func_cast6(i8* %13, i8* %f)
      br label %merge
